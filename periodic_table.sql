...
--
-- Name: elements uni_symbol; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uni_symbol UNIQUE (symbol);


--
-- Name: properties fk_number; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_number FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
